...
3. [https://greasyfork.org/ko/scripts/541829-vod-master-soop](https://greasyfork.org/ko/scripts/541829-vod-master-soop)에서 스크립트를 설치하세요.
...
- 버그 수정
  - 편집VOD로 제작된 VOD에 대해 이전 채팅 복원 기능이 동작하지 않는 문제를 수정했습니다.
  - VOD가 전체 공개가 아닌 경우 오류가 발생하는 문제를 수정했습니다.
