...
- 타임라인 댓글을 다른 스트리머 다시보기와 동기화할 때 변환할 수 있는 기능이 추가되었습니다.
  - 타임라인이 포함된 댓글의 우측상단에 표시된 `동기화할 때 이 타임라인을 변환`을 클릭하여 활성화하고 동기화를 진행하면 동기화된 다시보기 페이지에서 변환된 타임라인 댓글을 확인하고 미세조정, 복사를 할 수 있습니다.
- 이전 채팅 복원 설정에서 이모티콘만으로 구성된 채팅은 제외할 수 있는 기능이 추가되었습니다.
- 성능 최적화
- [버그수정]
